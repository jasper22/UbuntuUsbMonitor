    ...
    internal class SocketProxy : IDisposable
    {
        ...
        public int GetSocketOption(int option, out int value)
        {
            ...
            using (var optionValue = new DisposableIntPtr(Marshal.SizeOf(typeof(int))))
            {
                ...
                int rc = Retry.IfInterrupted(LibZmq.zmq_getsockopt, SocketHandle, option, optionValue.Ptr, optionLength.Ptr);
        ...
        public int GetSocketOption(int option, out long value)
        {
            ...
            using (var optionValue = new DisposableIntPtr(Marshal.SizeOf(typeof(long))))
            {
                ...
                Func<IntPtr,int,IntPtr,IntPtr, int> func1 = (x1, x2, x3 , x4) => {
                    return LibZmq.zmq_getsockopt(SocketHandle, option, optionValue.Ptr, optionLength.Ptr);
                };

                //int rc = Retry.IfInterrupted(LibZmq.zmq_getsockopt.Invoke, SocketHandle, option, optionValue.Ptr, optionLength.Ptr);
                int rc = Retry.IfInterrupted(func1, SocketHandle, option, optionValue.Ptr, optionLength.Ptr);
        ...
        public int SetSocketOption(int option, string value)
        {
            if (value == null)
            {
                return Retry.IfInterrupted(LibZmq.zmq_setsockopt, SocketHandle, option, IntPtr.Zero, 0);
            }
            ...
            using (var optionValue = new DisposableIntPtr(encoded.Length))
            {
                ...
                return Retry.IfInterrupted(LibZmq.zmq_setsockopt, SocketHandle, option, optionValue.Ptr, value.Length);
            }
        }
        ...
        public int SetSocketOption(int option, int value)
        {
            using (var optionValue = new DisposableIntPtr(Marshal.SizeOf(typeof(int))))
            {
                ...
                return Retry.IfInterrupted(LibZmq.zmq_setsockopt, SocketHandle, option, optionValue.Ptr, sizeof(int));
            }
        }
        ...
        public int SetSocketOption(int option, long value)
        {
            using (var optionValue = new DisposableIntPtr(Marshal.SizeOf(typeof(long))))
            {
                ...
                return Retry.IfInterrupted(LibZmq.zmq_setsockopt, SocketHandle, option, optionValue.Ptr, sizeof(long));
            }
        }
        ...
        public int SetSocketOption(int option, ulong value)
        {
            using (var optionValue = new DisposableIntPtr(Marshal.SizeOf(typeof(ulong))))
            {
                ...
                return Retry.IfInterrupted(LibZmq.zmq_setsockopt, SocketHandle, option, optionValue.Ptr, sizeof(ulong));
            }
        }
